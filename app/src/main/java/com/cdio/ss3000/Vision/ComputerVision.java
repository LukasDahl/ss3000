...
public class ComputerVision {
    ...
    static int enfarve = 0, tofarve = 0, trefarve = 0;
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            for (int xx2 = 0; xx2 <= 255; xx2+=64) {
                for (int xx3 = 0; xx3 <= 255; xx3+=64) {
                    for (int xx4 = 0; xx4 <= 255; xx4+=64) {
...
//                            );
                        ...
                        System.out.println("NICE " + niceniceconf + " " + enfarve + " " + tofarve + " " + trefarve);
    ...
    private Mat convertToSquare(Mat imgOriginal, Rect rect) {
        ...
        Core.copyMakeBorder(img, img, t, b, l, r, Core.BORDER_CONSTANT, new Scalar(enfarve, tofarve, trefarve));
